...
'''This module contains the basic functions for
    ...
    3. Using the trained bootstrap models to predict the lifetime ('Total_years') of donors.
    4. Using the trained bootstrap models to create the cummulative hazard functions for donors.
    '''
